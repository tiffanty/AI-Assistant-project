                      ...
                      <ul className="flex space-x-28">
                        {navigation.map((item) => (
                          <li key={item.name}>
                            <Link
                              href={item.href}
                              className="bg-[#1e3a8a] text-white text-center text-xl not-italic font-normal leading-[normal] px-4 py-1 rounded-lg transition-colors duration-200 hover:bg-[#243c6c]"
                ...
                {user ? (
                  <div className="hidden sm:flex absolute inset-y-0 right-0 gap-6 items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                    <Link href="/notes">
                      <button
                        type="button"
                        className=" text-white text-center text-xl not-italic font-normal leading-[normal] font-montserrat px-[22px] py-[11px] bg-[#1e3a8a] rounded-lg"
                      >
                        nAgents
                      </button>
                    </Link>
          ...
          <DisclosurePanel className="sm:hidden">
            <div className="space-y-1 px-2 pb-3 pt-2 flex flex-col gap-3 items-start">
              ...
              <div className="flex gap-6 items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                <Link
                  href="/notes"
                  className=" text-white text-center text-xl not-italic font-normal leading-[normal] font-montserrat px-5 py-1.5 bg-[#1e3a8a] rounded-lg"
                >
                  Get Started
                </Link>
              </div>
