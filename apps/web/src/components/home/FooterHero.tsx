      ...
      <div className="flex flex-wrap md:flex-nowrap justify-between container py-20 px-6 sm:px-0">
        <div className="max-w-[802px]">
          ...
          <p className="text-white max-w-[681px] text-xl sm:text-3xl not-italic font-normal leading-[103.3%] tracking-[-0.75px] font-montserrat pb-[66px] sm:pb-[53px]">
            Sign up now and experience the future of communication with intelligent voice AI that handles your calls
          </p>
          <Link href={"/notes"}>
            <button className="bg-[#1e3a8a] flex max-w-[438px] w-full justify-center items-center gap-2.5 shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] px-8 py-4 rounded-[11px]  text-white text-xl sm:text-3xl not-italic font-semibold leading-[90.3%] tracking-[-0.75px]">
              Try nAgents Free
            </button>
          </Link>
        </div>
