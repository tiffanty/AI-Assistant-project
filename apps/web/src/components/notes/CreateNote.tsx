    ...
    <>
      <div className="flex justify-center items-center">
        <button
          ...
          className="bg-[#1e3a8a] text-white flex gap-4 justify-center items-center text-center px-8 sm:px-16 py-2 rounded-lg"
        >
          <Image
            src={"/images/Add.png"}
            width={40}
              ...
              >
                <Dialog.Panel className="relative transform overflow-hidden rounded-[10px] bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-[719px]">
                  ...
                  <div className=" px-4 py-3 mb-5 flex justify-center items-center">
                    <button
                      type="button"
                      className="text-white text-center text-[17px] sm:text-2xl not-italic font-semibold leading-[90.3%] tracking-[-0.6px] px-[70px] py-2 bg-[#1e3a8a] rounded-lg"
