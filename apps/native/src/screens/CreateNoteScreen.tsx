  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.underHeaderContainer}>
        ...
        <Text style={styles.title}>Create Call Note</Text>
        <TouchableOpacity>
          <Image
            style={styles.arrowBack}
      ...
      >
        <View style={styles.inputContainer}>
          <Text style={styles.inputLabel}>Call Title</Text>
          <TextInput
            value={noteTitle}
        ...
        >
          {isCreating ? (
            ...
            <>
              ...
              <Text style={styles.newNoteButtonText}>Create Call Note</Text>
            </>
          )}
        </TouchableOpacity>
      </Animated.View>
